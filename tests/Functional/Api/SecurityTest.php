...
class SecurityTest extends AbstractFunctionalTestCase
{
    ...
    public function testConfirmPassword(): void
    {
        ...
        /** @var User $user */
        $user = $em->getRepository(User::class)->findOneBy(['email' => 'magicbart@videogamesrecords.net']);
    ...
    public function testPasswordRequestedMore24Hours(): void
    {
        ...
        /** @var User $user */
        $user = $em->getRepository(User::class)->findOneBy(['username' => 'magicbart']);
